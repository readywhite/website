...
- If Squarespace owns the public form, point its submission/webhook to `https://YOUR-RAILWAY-URL/api/ghl-lead`; `server.js` will create the contact and opportunity via the GoHighLevel API.
